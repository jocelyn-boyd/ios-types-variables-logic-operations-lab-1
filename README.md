...
Solution
```
var secondsInAHour = 60 * 60 //3600 seconds
var secondsInADay = secondsInAHour * 24 //86400 seconds
var secondsInAYear = secondsInADay * 365 //31536000
```
***
## 5. Number of Pixels
...
Solution
```
var rockysAgeInHumanYears = rockyAgeInDogYears / 7
```
***
## 10. Alice's Age
